...
<li><a id="Menu-Setup" title="Setup" href="{routePath('admin-setup-index')}"><span class="hidden-xs">{$_ADMINLANG.setup.title}</span><span class="visible-xs"><i class="fa fa-cog"></i></span></a>
  <ul>
