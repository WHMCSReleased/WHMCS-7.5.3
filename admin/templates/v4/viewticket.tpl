        ...
        <td class="fieldarea">
            <div class="row">
                ...
                <div class="col-sm-4 top-margin-5">
                    <a href="#" id="add-file-upload" class="btn btn-success btn-xs add-file-upload" data-more-id="fileuploads"><i class="fa fa-plus"></i> {$_ADMINLANG.support.addmore}</a>
                </div>
            </div>
        </td>
    </tr>
        ...
        <tr>
            ...
            <td class="fieldarea">
                <div class="row">
                    ...
                    <div class="col-sm-4 top-margin-5">
                        <a href="#" id="add-note-file-upload" class="btn btn-success btn-xs add-file-upload" data-more-id="note-file-uploads"><i class="fa fa-plus"></i> {$_ADMINLANG.support.addmore}</a>
                    </div>
                </div>
            </td>
        </tr>
