...
$_LANG['remoteAuthn']['connectWith'] = "Connexion avec :provider";
$_LANG['remoteAuthn']['signUpWith'] = "S'enregistrer avec :provider";

$_LANG['unlink'] = "Dissocier";

$_LANG['invoicePaymentSuccessAwaitingNotify'] = "Merci d'avoir complété le processus de paiement. Nous attendons une notification pour confirmer le paiement que vous venez de faire. Nous vous enverrons un e-mail de confirmation dès que celui-ci aura été reçu.";
...
$_LANG['creditCard']['removeDescription'] = "Êtes-vous sûr de vouloir supprimer les informations de votre carte de crédit?";

$_LANG['marketConnect']['weebly']['ftpHost'] = "Hôte FTP";
$_LANG['marketConnect']['weebly']['ftpUsername'] = "Nom d'utilisateur FTP";
$_LANG['marketConnect']['weebly']['ftpPassword'] = "Mot de passe FTP";
$_LANG['marketConnect']['weebly']['ftpPath'] = "Répertoire FTP";
$_LANG['marketConnect']['weebly']['updateFtp'] = "Mettre à jour les informations FTP";
$_LANG['marketConnect']['weebly']['manage'] = "Se connecter à Weebly";

$_LANG['domainChecker']['contactSupport'] = "Contacter le support pour pouvoir acheter";

$_LANG['cart']['availableCreditBalance'] = "Votre solde créditeur disponible est :amount.";
$_LANG['cart']['applyCreditAmount'] = "Appliquer <span>:amount</span> de mon solde créditeur à cette commande et je paierai le montant restant via la méthode de paiement choisie ci-dessous.";
...
$_LANG['cart']['applyCreditSkip'] = "N'appliquez aucun crédit sur mon solde créditeur à cette commande. Je vais entièrement payer en utilisant la méthode de paiement sélectionnée ci-dessous.";
