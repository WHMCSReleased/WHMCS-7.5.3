    ...
    public function generateOutput($data)
    {
        ...
        foreach ($data as $key => $toDoItem) {
            ...
            if ($admin == Session::get('adminid')) {
                $assigned = ' <i class="fa fa-user color-green" data-toggle="tooltip" data-placement="bottom" title="Assigned to you"></i>';
            } elseif ($admin > 0) {
                $assigned = ' <i class="fa fa-user color-cyan" data-toggle="tooltip" data-placement="bottom" title="Assigned to somebody else"></i>';
            } else {
                $assigned = ' <i class="fa fa-user color-grey" data-toggle="tooltip" data-placement="bottom" title="Unassigned"></i>';
            }
